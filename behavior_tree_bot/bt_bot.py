...
def setup_behavior_tree():
    # setup_behavior_tree1()              #default
    # setup_behavior_tree2()              #balanced; hybrid
    setup_behavior_tree3()              #greedy; prioritize weakest neutral planets, then attack weakest planets 
    # setup_behavior_tree4()              #conservative; if enemy is weaker, attack the weakest planet; else if neurtal planets, get weakest; else send help to weak ally
    # setup_behavior_tree5()              #aggressive; Attack closest enemies; if can't attack, colonize; else, attack the weakest planet
    return
...
def setup_behavior_tree2():
    ...
    expand_loop = LoopUntilFail(Action(spread_to_weakest_neutral_planet))
...
def setup_behavior_tree3():
    from behavior_tree_bot.bt_nodes import LoopUntilFail, Check, Action, Selector, Sequence

    root = Selector(name='Greedy Expander Strategy')

    # Loop spreading to neutral planets
    loop_spread = LoopUntilFail(Action(spread_to_weakest_neutral_planet))
...
def setup_behavior_tree5():
    from behavior_tree_bot.bt_nodes import Check, Action, Selector, LoopUntilFail
    ...
    spread_loop = LoopUntilFail(Action(spread_to_weakest_neutral_planet))
